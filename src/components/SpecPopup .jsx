...
const SpecPopup = ({ children, className = "" }) => {
    return (
        <span
            className={`pf-absolute pf-left-1/2 pf-bottom-[calc(100%+16px)] pf--translate-x-1/2
      pf-rounded-[3px] pf-p-2
      pf-bg-[#004890] pf-text-white pf-font-[700] pf-text-[12px]
      leading-[16px]
      pf-w-screen pf-max-w-[344px]
      ...
      ${className}`}
        >
            ...
            <ArrowDown className="pf-absolute pf--bottom-2 pf-left-1/2 pf--translate-x-1/2" />
        </span>
    );
};
